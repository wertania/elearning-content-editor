  ...
  <div>
    ...
    <div v-else class="grid w-full mt-1" style="height: calc(100vh - 105px)">
      ...
      <div class="col-6">
        ...
        <Button
          v-tooltip.bottom="'Re-Upload media'"
        ...
        <div v-if="itemSelected">
          <div
            class="flex flex-row flex-wrap card-container blue-container mr-2 mt-2 mb-2"
          >
            <Button
              icon="fa-solid fa-plus"
...
const confirmSelection = () => {
  if (itemSelected.value == null) return;
  emit('media-selected', itemSelected.value);
};
