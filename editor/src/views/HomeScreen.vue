    ...
    <template #content>
      <div class="m-auto m-0 w-4 mt-5 h-screen min-w-min">
        <GradientFont
          ...
          start-color="rgb(255 249 154)"
          end-color="rgb(255 162 222)"
          style="font-weight: 800; font-size: 25px"
        >
          <h2>Welcome back</h2>
        </GradientFont>
        ...
        <GardientBox
          ...
          class="mt-4 cursor-pointer text-center text-white"
          bg="transparent"
          @click="openFastViewer()"
        >
          <h2 style="color: #ca566f">
