...
if TTS_MODEL == "google" and not GOOGLE_CREDENTIALS_PATH:
    raise Exception("Please set the environment variable GOOGLE_CREDENTIALS_PATH")
elif TTS_MODEL == "elevenlabs" and not ELEVENLABS_API_KEY:
    raise Exception("Please set the environment variable ELEVENLABS_API_KEY")
# elif TTS_MODEL == "whisper" and not WHISPER_API_KEY:
#     raise Exception("Please set the environment variable WHISPER_API_KEY")
